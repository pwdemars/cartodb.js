...
var Annotation = View.extend({
  ...
  _belongsToCanvas: function () {
    var mobile = (this.options.device === 'mobile');
  ...
  _applyStyle: function () {
    ...
    var textAlign = this.style.get('textAlign');
    // var boxColor = this.style.get('boxColor'); eslint: never-used
    // var boxOpacity = this.style.get('boxOpacity'); eslint: never-used
    var boxPadding = this.style.get('boxPadding');
    var lineWidth = this.style.get('lineWidth');
    // var lineColor = this.style.get('lineColor'); eslint: never-used
